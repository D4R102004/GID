...
**"5 Souls to the Rescue"** (team forms in Arc 3):

1. **Arjan** (15, Arc 1) - Island, Gallan's ward, 30% Kami reincarnation (unaware)
2. **Lopney** (15, Arc 1) - Island, Gallan's ward, 30% Kami reincarnation (unaware)  
3. **Yonoa Houzu** (33, Arc 1) - Jitsumoto heir, future Shogun, oldest protagonist
4. **Ichiro Kiryuin** (~17, Arc 2) - Free shopkeeper & stage magician, former Kiryuin assassin
5. **Lyzander Sugimori** (~19, Arc 2) - Free, Meiji's adoptive son
...
**Hirohiko Dei/Gyrus/Dr. Araki** (~38, Arc 1) - Middle child, amnesiac, **possessed by Jashin** (doesn't know)
...
**PRISTANIA** - Authoritarian morality enforcement, led by the Kamigami, illegal organization
**FREE** - Freedom/free will rebellion, led by Meiji, illegal organization
**JITSUMOTO** - Neutral mediator, led by Shogun Shigeru Houzu, not illegal but secretive

---

## POWER DISTRIBUTION

**Kami's power:** 30% → Arjan + 30% → Lopney + 40% → sealed in Kami's corpse
**Jashin's power:** ~60% → sealed in comatose body + ~40% → possessing Hirohiko
**Megami's power:** 100% → with Rajin

---

## VERIFICATION SOURCES

- Character ages: Individual character profile headers
- Deaths: Character arc sections in profiles
- Timeline: GID_MASTER_LORE.md lines 95-250
- Kamigami roster: GID_MASTER_LORE.md lines 101-104
- Faction info: Factions.md

**For detailed character information, always read the full character profile file.**
